...
#chondrite
#PalmeOneill2014CI
#Oneill2014Mantle : cannot be used (bug)
#McDonough1995CI
...
filepath2 = file.path(sourceDir, file2) 
...
#c("La", "Pr", "Ce", "Eu", "Y", "Ho", "Tm", "Tb"), Marco
#c("La", "Pr", "Ce", "Eu", "Y"), best combination within 0.01, La preserved
